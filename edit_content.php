			...
			<div class="col-md-9" id="content-view">
				<div class="thread">
						<div class="row topic">
							...
							<div class="col-xs-11">
								<h4>Editing Topic: <a href="content.php">Why do we use this specific syntax for defining functions?</a></h4>
								<p class="info">
						...
						<div class="context">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="title" placeholder="Title" value="Why do we use this specific syntax for defining functions?">
								</div>
								<div class="form-group">
